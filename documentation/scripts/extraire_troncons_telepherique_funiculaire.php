...
/**
 * Meme principe que extraire_troncons_bus_reste.php, pour les 2 dernieres lignes sans aucune
 * topologie apres la completion du reseau bus (2026-08-20) : le Cable A / C1 (telepherique urbain
 * de Creteil, codeExterne C02666, 5 Desserte) et le Funiculaire de Montmartre (FUN, codeExterne
 * C01385, 2 Desserte). Liste des 2 lignes tapee a la main (perimetre trivial, contrairement au
 * reste du reseau bus), reste de l'algorithme identique (extraction GTFS + reduction geometrique).
 *
 * Sortie : documentation/scripts/donnees-extraites/troncons_telepherique_funiculaire.csv
...
const SORTIE = 'documentation/scripts/donnees-extraites/troncons_telepherique_funiculaire.csv';
const DUREE_MAX_SECONDES = 1800;
const MARGE_RACCOURCI = 1.25;
const CODES = ['C02666', 'C01385'];
...
echo count($tripVersCode)." trips trouves.\n";
